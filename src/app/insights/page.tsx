...
export const metadata: Metadata = {
  ...
  description: 'Discover expert sales insights, AI coaching strategies, and industry best practices. Learn how to boost your sales team performance with Ematrics.',
  keywords: 'sales insights, sales tips, AI sales coaching, sales training, sales performance, sales blog',
}
...
const featuredPost = {
  ...
  content: "Sales coaching has traditionally been a reactive process - managers review calls after they've happened, provide feedback during weekly one-on-ones, and hope that insights stick...",
  author: "Sarah Chen",
...
const recentPosts = [
  ...
  },
  {
    ...
    excerpt: "Best practices for managing and coaching distributed sales teams, from virtual ride-alongs to digital performance tracking.",
    author: "David Kim",
  ...
  },
  {
    ...
    excerpt: "Dive deep into the psychological factors that influence B2B purchase decisions and how to align your sales approach accordingly.",
  ...
  },
  {
    ...
    excerpt: "How to integrate your sales tools effectively to create a seamless workflow that actually helps your team sell more.",
    author: "Alex Johnson",
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-6 text-xl text-primary-100 max-w-3xl mx-auto">
              Stay ahead of the curve with expert insights on AI-powered sales coaching, proven techniques, and industry best practices.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="p-8 lg:p-12">
                  <div className="flex items-center space-x-2 mb-4">
                    ...
                    <span className="text-primary-600 text-sm">{featuredPost.category}</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="font-semibold text-charcoal-900">{featuredPost.author}</p>
                        <p className="text-sm text-charcoal-600">{featuredPost.authorRole}</p>
                      </div>
                    </div>
                ...
                <div className="lg:p-8">
                  <div className="bg-gradient-to-br from-primary-100 to-teal-100 rounded-xl h-full min-h-[300px] flex items-center justify-center">
                    <span className="text-primary-600 font-medium">Featured Article Image</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Recent Posts Grid */}
          <div>
            <h2 className="text-2xl font-bold text-charcoal-900 mb-8">Recent Articles</h2>
              ...
              {recentPosts.map((post) => (
                <article key={post.id} className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow">
                  <div className="bg-gradient-to-br from-gray-100 to-gray-200 h-48 flex items-center justify-center">
                    <span className="text-charcoal-400 font-medium">Article Image</span>
                  </div>
                  <div className="p-6">
                    ...
                    <h3 className="font-bold text-charcoal-900 mb-3 line-clamp-2">
                      <Link href={`/insights/${post.id}`} className="hover:text-primary-600">
                        {post.title}
                      </Link>
                    </h3>
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                      <div className="flex items-center space-x-2">
                        ...
                        <div>
                          <p className="font-medium text-charcoal-900 text-sm">{post.author}</p>
                          <p className="text-xs text-charcoal-500">{post.authorRole}</p>
                        </div>
                      </div>
      ...
      <section className="bg-gray-50 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-charcoal-600 mb-8">
            Get the latest sales strategies, AI coaching tips, and industry insights delivered to your inbox.
          </p>
